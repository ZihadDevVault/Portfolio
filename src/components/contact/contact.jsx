...
const Contact=()=>{
  ...
  const onSubmit = async (event) => {
    ...
    <div id="Contact" className="w-full px-[12%] py-10 scroll-mt-20 bg-[url('/footer-bg-color.png')] bg-no-repaet bg-center bg-[lenght:90%_auto] dark:bg-none">
        ...
        <form onSubmit={onSubmit} className="max-w-2xl mx-auto">
            ...
            <textarea rows='6' placeholde="Enter your message" required className="w-full p-4 outline-none border-[0.5px] border-gray-400 rounded-md bg-white mb-6 dark:bg-darkHover/30 dark:border-white/90" name="message"></textarea>
            <button type='submit' className="py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500 cursor-pointer dark:bg-transparent dark:border-[.5px] dark:hover:bg-darkHover">Submit now <img src={assets.right_arrow_white} alt="RightArrow" className="w-4"/></button>
